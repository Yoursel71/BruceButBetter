...
#include "modules/NRF24/nrf_esb_sniffer.h"
...
void NRF24Menu::optionsMenu() {
    ...
    #endif
    options.push_back({"Jammer Presets", nrf_jammer_presets});
    options.push_back({"NRF Jammer",     nrf_jammer});
    options.push_back({"Dual Jammer",    nrf_dual_jammer});
    options.push_back({"Reactive Jam",   nrf_reactive_jammer});
    options.push_back({"ESB Sniffer",    nrf_esb_sniffer});
